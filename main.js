...
const spaceTexture = new THREE.TextureLoader().load('images/yooo-semite-DTWP.jpg');
scene.background = spaceTexture;

// Avatar

const brianTexture = new THREE.TextureLoader().load('images/brian.JPG');
...
const BLUTexture = new THREE.TextureLoader().load('images/normal.jpeg');
